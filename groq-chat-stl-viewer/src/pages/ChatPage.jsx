...
const GREETING = 'Hi! Ask me anything about STL models or 3D content.'
const SYSTEM_PROMPT = [
...
export default function ChatPage() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      const message = aborted ? 'Request cancelled.' : 'Unable to reach the STL assistant. Please try again.'
      if (!aborted) {
        console.error('STL Viewer chat error', error)
      }
