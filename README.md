...
* `MetadataManager` centralizes page titles, descriptions, canonical URLs, and social tags via `react-helmet-async`, auto-populating entries for every experience route.【F:all_in/src/App.jsx†L35-L152】
