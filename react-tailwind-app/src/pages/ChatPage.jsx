...
export default function ChatPage() {
  ...
  const [conversations, setConversations] = useState([
    { id: 'conv-1', title: 'New Chat', messages: [
      { role: 'assistant', name: 'Groq', timestamp: Date.now(), content: 'Hi! Ask me anything.' },
    ]}
  ])
  ...
  function handleClear() {
    ...
    setConversations((prev) => prev.map((c) => c.id === activeId
      ? { ...c, messages: [{ role: 'assistant', name: 'Groq', timestamp: Date.now(), content: 'Hi! Ask me anything.' }], title: 'New Chat' }
      : c
    ))
  }
            ...
            <Sidebar
              ...
              onNew={() => {
                ...
                setConversations((prev) => [
                  { id, title: 'New Chat', messages: [ { role: 'assistant', name: 'Groq', timestamp: Date.now(), content: 'Hi! Ask me anything.' } ] },
                  ...prev,
                ])
                setActiveId(id)
              }}
